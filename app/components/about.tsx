...
export default function About() {
  return (
    <motion.section className="mt-28 mb-28 max-w-[45rem] text-center leading-7 sm:mb-40 scroll-mt-28"
    ...
    >
      ...
      <p className="mb-3">
        ...
        <span className="font-medium">Global Studies</span>, I decided to pursue my
