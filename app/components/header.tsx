"use client"; 
//note: Because the flie is located in the /app/components folder it is assumed to be a server side component so you must explicitly denote a clientside component in order to use the motion.div because the motion component uses the useEffect hook which can only be used in client side components. Without this declaration the app will throw an error.
